...
<!-- Modal -->
<dialog id="createStudent" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<script>
    ...
    function openModal() {
        document.getElementById('createStudent').showModal();
    }

    // Function to close the modal
    function closeModal() {
        document.getElementById('createStudent').close();
    }
</script>
