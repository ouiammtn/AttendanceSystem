...
@section('content')
    ...
    <!-- Header -->
        ...
        <!--/ Subjects -->
         <!-- Script for SweetAlert notification -->
         <script>
            document.addEventListener('DOMContentLoaded', function () {
                var absenceCount = {{ $student->absent_count() }}; // Assuming this is the correct way to get absence count
                var threshold = 3; // Set your threshold here
